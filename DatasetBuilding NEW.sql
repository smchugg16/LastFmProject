--- Define parameters for date ranges (5 years) ---
DECLARE @StartDate DATE = '2020-04-11';
DECLARE @EndDate DATE = '2025-04-13';  -- Updated End Date
...
CREATE TABLE #TempFilteredScrobbles (
    ...
    Artist VARCHAR(MAX),   ---SQL was throwing errors for string lengths, so they were all increased
    Album VARCHAR(MAX),
    Title VARCHAR(MAX),
    Date DATE,
    Time TIME
...
WITH TimeOfDayAndSeason AS (
    SELECT
        ...
        CASE
            ...
            WHEN Date BETWEEN '2024-12-22' AND '2025-03-19' THEN 'Winter'
			WHEN Date BETWEEN '2025-03-20' AND '2025-06-19' THEN 'Spring'
            WHEN Date BETWEEN '2025-06-20' AND '2025-09-21' THEN 'Summer'
            WHEN Date BETWEEN '2025-09-22' AND '2025-12-20' THEN 'Fall'
			WHEN Date BETWEEN '2025-12-21' AND '2026-03-19' THEN 'Winter'
            ELSE 'Unknown'
        END AS Season
